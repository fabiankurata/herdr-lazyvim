...
hide_existing() {
  ...
  # Herdr uses the first move request on a zoomed pane to leave zoom mode.
  # Leave zoom mode explicitly so this toggle can park the pane as well.
  "$H" pane zoom "$primary" --off >/dev/null 2>&1 || true
